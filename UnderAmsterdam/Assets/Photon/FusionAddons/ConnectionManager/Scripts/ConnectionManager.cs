    ...
    public class ConnectionManager : MonoBehaviour, INetworkRunnerCallbacks
    {
        ...
        public void OnPlayerJoinedSharedMode(NetworkRunner runner, PlayerRef player)
        {
            if (player == runner.LocalPlayer && userPrefab != null)
            {
                ...
                NetworkObject networkPlayerObject = runner.Spawn(userPrefab, position: transform.position, rotation: transform.rotation, player);
            }
        }
        ...
        public void OnPlayerJoinedHostMode(NetworkRunner runner, PlayerRef player)
        {
            ...
            if (runner.IsServer && userPrefab != null)
            {
                ...
                NetworkObject networkPlayerObject = runner.Spawn(userPrefab, position: transform.position, rotation: transform.rotation, inputAuthority: player);
        ...
        public void OnConnectedToServer(NetworkRunner runner) {
            ...
            runner.LoadScene(ConnectionSettings.MainScene);
        }
